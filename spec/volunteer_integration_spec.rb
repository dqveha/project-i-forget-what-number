...
describe 'the project update path', {:type => :feature} do
  it 'allows a user to change the name of the project' do
    ...
    # click_link('Edit Project') (From Dave: Altered this since my project doesn't have an 'Edit Project' link)
...
describe 'the project delete path', {:type => :feature} do
  it 'allows a user to delete a project' do
    ...
    test_project.save
    id = test_project.id
    visit "/projects/#{id}" #(From Dave: took out the /edit phrase since my project doesn't require it)
